<template>
  <nav :class="['header', darkMode ? 'dark' : 'light']">
    <ul>
      ...
      <li><router-link to="/testapp">Testapp</router-link></li>-->
      <li v-if="isAuthenticated"><router-link to="/overview">Tabellen Übersicht</router-link></li>
      <li v-if="isAuthenticated"><router-link to="/overview2">Karten Übersicht</router-link></li>
